import { getNewArrivalsProductById } from '@/app/db/quries';
...
const NweArrivalsPageDetails = async ({ params: { id } }) => {
  const product = await getNewArrivalsProductById(id);
  return (
...
export default NweArrivalsPageDetails;
