import { getKidsFashionProductById } from '@/app/db/quries';
...
const KidsFashionDetailsPage = async ({ params: { id } }) => {
  const product = await getKidsFashionProductById(id);
...
export default KidsFashionDetailsPage;
