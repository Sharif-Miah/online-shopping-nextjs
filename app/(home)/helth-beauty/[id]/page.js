import { getHealthAndBeutyProductById } from '@/app/db/quries';
...
const HealthAndBeautyDetailsPage = async ({ params: { id } }) => {
  const product = await getHealthAndBeutyProductById(id);
...
export default HealthAndBeautyDetailsPage;
