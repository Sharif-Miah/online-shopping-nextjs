import { getPhoneAndGadgetsProductById } from '@/app/db/quries';
...
const PhoneAndGadgetsDetails = async ({ params: { id } }) => {
  const phone = await getPhoneAndGadgetsProductById(id);
      ...
      <div className='my-8'>
        <div className='flex flex-col md:flex-row  gap-2'>
          ...
          <div className='flex-grow w-full md:w-2/3  ml-5'>
            <div className='flex flex-col md:flex-row gap-2'>
              {/* Middle Column  */}
              <ProductCalculate product={phone} />
              {/* Last column  */}
              <div className='flex-shrink-0 w-full md:w-1/3 '>
                <DeleveryQA />
                {/* <SimilarProduct /> */}
...
export default PhoneAndGadgetsDetails;
