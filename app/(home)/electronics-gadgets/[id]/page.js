import { getElectricGadgetsProductById } from '@/app/db/quries';
...
const ElectronicAndGadgetDetailsPage = async ({ params: { id } }) => {
  const product = await getElectricGadgetsProductById(id);
...
export default ElectronicAndGadgetDetailsPage;
